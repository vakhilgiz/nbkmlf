    ...
    class GUIProcessManager {
        ...
        static processFacetReduction(facetResult, settings, colormapResult, cancellationToken) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                document.getElementsByClassName("loaded_img")[0].getElementsByClassName("tn-atom")[0].style.backgroundImage = document.getElementById("cReduction").toDataURL();
            });
        }
            ...
            if (files !== null && files.length > 0) {
                ...
                reader.onloadend = function () {
                    ...
                    img.onload = () => {
                        ...
                        document.getElementsByClassName("loaded_img")[0].getElementsByClassName("tn-atom")[0].style.backgroundImage = c.toDataURL();
                    };
                    img.onerror = () => {
